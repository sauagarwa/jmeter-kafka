...
#
oc new-app --docker-image=docker.io/chengkuan/jmeter-kafka:1.0 
--name=jmeter-kafka -e "JMETER_THREADS=300" 
-e "BOOTSTRAP_SERVERS=kafka-cluster-kafka-bootstrap:9092"  
-e "PROMETHEUS_PORT=8080" -e "PROMETHEUS_HOST=0.0.0.0" 
-e "SAMPLER_LABEL=lt-p3r3-bs3700-t300r60" -e "BATCH_SIZE=3700" 
-e "HEAP=-Xms512m -Xmx4096m" -e "RAMUP_PERIOD=60" -e "LOOP_COUNT=-1" 
-e "KAFKA_TOPIC=jmeter-kafka" -l app=jmeter -n kafka-jmeter